package solved.marathon.dec24.forth.g9983;
...
public class Main {
    ...
    static boolean checkAttack(int x, int y, String piece, boolean[][] bBoard) {
    ...
    static boolean check(int mask) {
        boolean[][] bBoard = new boolean[16][16];
        ...
        for (int i = 0; i < count; i++) {
            ...
            if (piece.equals("E") && !checkAttack(x, y,  piece, bBoard)) {
                return false;
            }
        }
        return true;
